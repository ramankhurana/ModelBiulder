...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  controlmc_sigfail = _fin.Get("signal_fail_zjets")
  ...
  ZvvScales_sigfail = target.Clone(); ZvvScales_sigfail.SetName("sig_fail_weights_%s"%cid)
  ZvvScales_sigfail.Divide(controlmc_sigfail)
  _fOut.WriteTObject(ZvvScales_sigfail)  # always write out to the directory 
  ...
  #dummy for now:
  h_trig_up = target.Clone()
  h_trig_down = target.Clone()
  ...
  zmm_fail_ratio_trig_up = target.Clone(); zmm_fail_ratio_trig_up.SetName('zmm_fail_weights_%s_mettrig_Up'%cid)
  for b in range(zmm_fail_ratio_trig_up.GetNbinsX()): zmm_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(zmm_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_zjets"))
  zmm_fail_ratio_trig_up.Divide(controlmc_fail)
  _fOut.WriteTObject(zmm_fail_ratio_trig_up)
  ...
  zmm_fail_ratio_trig_down = target.Clone(); zmm_fail_ratio_trig_down.SetName('zmm_fail_weights_%s_mettrig_Down'%cid)
  for b in range(zmm_fail_ratio_trig_down.GetNbinsX()): zmm_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(zmm_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_zjets"))
  zmm_fail_ratio_trig_down.Divide(controlmc_fail)
  _fOut.WriteTObject(zmm_fail_ratio_trig_down)
  ...
  zee_fail_ratio_trig_up = target.Clone(); zee_fail_ratio_trig_up.SetName('zee_fail_weights_%s_mettrig_Up'%cid)
  for b in range(zee_ratio_trig_up.GetNbinsX()): zee_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(zee_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_zjets"))
  zee_fail_ratio_trig_up.Divide(controlmc_e_fail)
  _fOut.WriteTObject(zee_fail_ratio_trig_up)
  ...
  zee_fail_ratio_trig_down = target.Clone(); zee_fail_ratio_trig_down.SetName('zee_fail_weights_%s_mettrig_Down'%cid)
  for b in range(zee_fail_ratio_trig_down.GetNbinsX()): zee_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(zee_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_zjets"))
  zee_fail_ratio_trig_down.Divide(controlmc_e_fail)
  _fOut.WriteTObject(zee_fail_ratio_trig_down)
  ...
  Channel("signalfailModel",_wspace,out_ws,cid+'_'+model,ZvvScales_sigfail),
  ...
  for i in range(1,ZmmScales.GetNbinsX()+1):
    ...
    ZmmScale_doubleb_failUp.SetBinContent(i,val_fail*(1+double_b_uncs[i-1]))
    ZmmScale_doubleb_failDown.SetBinContent(i,val_fail*(1-double_b_uncs[i-1]))
    ...
    ZeeScale_doubleb_failUp.SetBinContent(i,val_fail*(1+double_b_uncs[i-1]))

    ZeeScale_doubleb_failDown = ZeeScales_fail.Clone()
    ZeeScale_doubleb_failDown.SetBinContent(i,val_fail*(1-double_b_uncs[i-1]))
  ...
  addStatErrs(ZeeScales_fail,CRs[4],'sig_fail','signalfailModelCR')

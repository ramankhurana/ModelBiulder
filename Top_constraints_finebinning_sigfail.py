...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  controlmc_sig_fail    = _fin.Get("signal_fail_ttbar")
  ...
  TopScales_sig_fail  = makeTop(cid,_fOut,"sigt_fail",targetmc,controlmc_sig_fail,diag,_wspace,None,False)
  ...
  CRs = [
   ...
   Channel("signalfailtModel",  _wspace,out_ws,cid+'_'+model,TopScales_sig_fail),
  ]
  ...
  addTopErrors(TopScales_sig_fail, targetmc,"sigt_fail", "signalfailtModel",   _fOut,CRs,6,cid,False)

...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  controlmc_sig_fail        = _fin.Get("signal_fail_zjets")            # defines Zmm MC of which process will be controlled by   
  ...
  ZsigScales_fail = target.Clone(); ZsigScales_fail.SetName("sig_fail_weights_%s"%cid)
  ZsigScales_fail.Divide(controlmc_sig_fail)
  _fOut.WriteTObject(ZsigScales_fail)  # always write out to the directory          
  ...
  Channel("signalfailModel",_wspace,out_ws,cid+'_'+model,ZsigScales_fail),
  ...
  addStatErrs(ZsigScales_fail,CRs[4],'sig_fail','signalfailModelCR')

...
def makeTop(cid,_fOut,newName,targetmc,controlmc,diag,wspace,systs=None,doSJ=False):
  ...
  if not(systs==None):
    for uncert in ['btag','mistag']:
      ...
      for i in xrange(1, targetmc.GetNbinsX()+1):
    #print 'BLAHBLAH ',newName,i,targetmc.GetBinContent(i),targetmc.GetBinError(i), controlmc.GetBinContent(i), TopScales.GetBinContent(i)
        
        if targetmc.GetBinContent(i) == 0:
          TopScalesDown.SetBinContent(i,0)
          TopScalesDown.SetBinError(i,0)
          TopScalesUp.SetBinContent(i,0)
          TopScalesUp.SetBinError(i,0)
  ...
  for i in xrange(1, targetmc.GetNbinsX()+1):
    ...
    if targetmc.GetBinContent(i) == 0:
      TopScales.SetBinContent(i,0)
      TopScales.SetBinError(i,0)
...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  '''
  for i in range(1,targetmc.GetNbinsX()+1):
    if controlmc.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc.SetBinContent(i,1)
      controlmc.SetBinError(i,0)
    if controlmc_fail.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc_fail.SetBinContent(i,1)
      controlmc_fail.SetBinError(i,0)
    if controlmc_e.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc_e.SetBinContent(i,1)
      controlmc_e.SetBinError(i,0)
    if controlmc_e_fail.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc_e_fail.SetBinContent(i,1)
      controlmc_e_fail.SetBinError(i,0)
    if controlmc_w_e.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc_w_e.SetBinContent(i,1)
      controlmc_w_e.SetBinError(i,0)
    if controlmc_w.GetBinContent(i) == 0:
      targetmc.SetBinContent(i,1)
      controlmc_w.SetBinContent(i,1)
      controlmc_w.SetBinError(i,0)
  '''

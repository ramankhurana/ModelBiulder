...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  ZmmScale_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("zmm_fail",cid,cid))
  ZmmScale_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("zmm_fail",cid,cid))

  ZeeScale_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("zee_fail",cid,cid))
  ZeeScale_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("zee_fail",cid,cid))

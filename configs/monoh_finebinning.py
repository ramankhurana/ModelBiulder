...
#bins = [200,270,350,475,600,1000,2000]

#bins = [200,225,250,275,310,350,400,450,500,550,600,800,1000,1250,2000]
bins = [200,250,310,400,500,750,1000,1250,2000]
...
#            ,'in_file_name':"/data/t3home000/bmaier/flat_v12/limits/limitForest_all.root"
            ...
            ,"cutstring":"1==1"
#            ,"cutstring":"N2DDT<0.4"
            ,"varstring":["min(1999.9999,met)",200,2000]
...
list_2hdma = [f for f in points_2hdma.points_2hdma]
string_2hdma = ""
for f in list_2hdma:
    signame = f
    while "_" in signame:
        signame = signame.replace("_","-")
    string_2hdma += signame + " "
    monohiggs_category['samples'][f+'_signal'] = ['signal',signame+"_signal",1,1]
...
'''
                  ...
                  ,"ZpA0_1200_300_signal"      :['signal','ZpA0-1200-300_signal',1,1]
                  ,"ZpA0_1200_400_signal"      :['signal','ZpA0-1200-400_signal',1,1]
                  ,"ZpA0_1200_500_signal"      :['signal','ZpA0-1200-500_signal',1,1]
                  ,"ZpA0_1200_600_signal"      :['signal','ZpA0-1200-600_signal',1,1]
                  ,"ZpA0_1200_700_signal"      :['signal','ZpA0-1200-700_signal',1,1]
                  ,"ZpA0_1200_800_signal"      :['signal','ZpA0-1200-800_signal',1,1]
                  ...
                  ,"ZpA0_4000_800_signal"      :['signal','ZpA0-4000-800_signal',1,1]
                                     ...
                                     # signal fail 
                  ,"VH_signal_fail"            :['signal_fail','vh',1,0]
                  ,"Zvv_signal_fail"                   :['signal_fail','zjets',1,0]
                  ,"Zll_signal_fail"                   :['signal_fail','zll',1,0]
                  ,"Wlv_signal_fail"           :['signal_fail','wjets',1,0]
                  ,"Diboson_signal_fail"               :['signal_fail','dibosons',1,0]
                  ,"ttbar_signal_fail"                 :['signal_fail','ttbar',1,0]
                  ,"ST_signal_fail"                 :['signal_fail','stop',1,0]
                  ,"QCD_signal_fail"                   :['signal_fail','qcd',1,0]
                  ,"Data_signal_fail"          :['signal_fail','data',0,0]
                  ,"ZpA0_600_300_signal_fail"       :['signal_fail','ZpA0-600-300_signal',1,1]
                  ,"ZpA0_600_400_signal_fail"       :['signal_fail','ZpA0-600-400_signal',1,1]
                  ,"ZpA0_800_300_signal_fail"       :['signal_fail','ZpA0-800-300_signal',1,1]
                  ,"ZpA0_800_400_signal_fail"       :['signal_fail','ZpA0-800-400_signal',1,1]
                  ,"ZpA0_800_500_signal_fail"       :['signal_fail','ZpA0-800-500_signal',1,1]
                  ,"ZpA0_800_600_signal_fail"       :['signal_fail','ZpA0-800-600_signal',1,1]
                  ,"ZpA0_1000_300_signal_fail"      :['signal_fail','ZpA0-1000-300_signal',1,1]
                  ,"ZpA0_1000_400_signal_fail"      :['signal_fail','ZpA0-1000-400_signal',1,1]
                  ,"ZpA0_1000_500_signal_fail"      :['signal_fail','ZpA0-1000-500_signal',1,1]
                  ,"ZpA0_1000_600_signal_fail"      :['signal_fail','ZpA0-1000-600_signal',1,1]
                  ,"ZpA0_1000_700_signal_fail"      :['signal_fail','ZpA0-1000-700_signal',1,1]
                  ,"ZpA0_1000_800_signal_fail"      :['signal_fail','ZpA0-1000-800_signal',1,1]
                  ,"ZpA0_1400_300_signal_fail"      :['signal_fail','ZpA0-1400-300_signal',1,1]
                  ,"ZpA0_1400_400_signal_fail"      :['signal_fail','ZpA0-1400-400_signal',1,1]
                  ,"ZpA0_1400_500_signal_fail"      :['signal_fail','ZpA0-1400-500_signal',1,1]
                  ,"ZpA0_1400_600_signal_fail"      :['signal_fail','ZpA0-1400-600_signal',1,1]
                  ,"ZpA0_1400_700_signal_fail"      :['signal_fail','ZpA0-1400-700_signal',1,1]
                  ,"ZpA0_1400_800_signal_fail"      :['signal_fail','ZpA0-1400-800_signal',1,1]
                  ,"ZpA0_1700_300_signal_fail"      :['signal_fail','ZpA0-1700-300_signal',1,1]
                  ,"ZpA0_1700_400_signal_fail"      :['signal_fail','ZpA0-1700-400_signal',1,1]
                  ,"ZpA0_1700_500_signal_fail"      :['signal_fail','ZpA0-1700-500_signal',1,1]
                  ,"ZpA0_1700_600_signal_fail"      :['signal_fail','ZpA0-1700-600_signal',1,1]
                  ,"ZpA0_1700_700_signal_fail"      :['signal_fail','ZpA0-1700-700_signal',1,1]
                  ,"ZpA0_1700_800_signal_fail"      :['signal_fail','ZpA0-1700-800_signal',1,1]
                  ,"ZpA0_2000_300_signal_fail"      :['signal_fail','ZpA0-2000-300_signal',1,1]
                  ,"ZpA0_2000_400_signal_fail"      :['signal_fail','ZpA0-2000-400_signal',1,1]
                  ,"ZpA0_2000_500_signal_fail"      :['signal_fail','ZpA0-2000-500_signal',1,1]
                  ,"ZpA0_2000_600_signal_fail"      :['signal_fail','ZpA0-2000-600_signal',1,1]
                  ,"ZpA0_2000_700_signal_fail"      :['signal_fail','ZpA0-2000-700_signal',1,1]
                  ,"ZpA0_2000_800_signal_fail"      :['signal_fail','ZpA0-2000-800_signal',1,1]
                  ,"ZpA0_2500_300_signal_fail"      :['signal_fail','ZpA0-2500-300_signal',1,1]
                  ,"ZpA0_2500_400_signal_fail"      :['signal_fail','ZpA0-2500-400_signal',1,1]
                  ,"ZpA0_2500_500_signal_fail"      :['signal_fail','ZpA0-2500-500_signal',1,1]
                  ,"ZpA0_2500_600_signal_fail"      :['signal_fail','ZpA0-2500-600_signal',1,1]
                  ,"ZpA0_2500_700_signal_fail"      :['signal_fail','ZpA0-2500-700_signal',1,1]
                  ,"ZpA0_2500_800_signal_fail"      :['signal_fail','ZpA0-2500-800_signal',1,1]
                  ,"ZpA0_2750_300_signal_fail"      :['signal_fail','ZpA0-2750-300_signal',1,1]
                  ,"ZpA0_2750_500_signal_fail"      :['signal_fail','ZpA0-2750-500_signal',1,1]
                  ,"ZpA0_2750_800_signal_fail"      :['signal_fail','ZpA0-2750-800_signal',1,1]
                  ,"ZpA0_3000_300_signal_fail"      :['signal_fail','ZpA0-3000-300_signal',1,1]
                  ,"ZpA0_3000_500_signal_fail"      :['signal_fail','ZpA0-3000-500_signal',1,1]
                  ,"ZpA0_3000_800_signal_fail"      :['signal_fail','ZpA0-3000-800_signal',1,1]
                  ,"ZpA0_3500_300_signal_fail"      :['signal_fail','ZpA0-3500-300_signal',1,1]
                  ,"ZpA0_3500_500_signal_fail"      :['signal_fail','ZpA0-3500-500_signal',1,1]
                  ,"ZpA0_3500_800_signal_fail"      :['signal_fail','ZpA0-3500-800_signal',1,1]
                  ,"ZpA0_4000_300_signal_fail"      :['signal_fail','ZpA0-4000-300_signal',1,1]
                  ,"ZpA0_4000_500_signal_fail"      :['signal_fail','ZpA0-4000-500_signal',1,1]
                  ,"ZpA0_4000_800_signal_fail"      :['signal_fail','ZpA0-4000-800_signal',1,1]

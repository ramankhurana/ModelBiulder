...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  TopScales_fail = makeTop(cid,_fOut,"topmn_fail",targetmc,controlmc_fail,systs_fail,False)
  TopScales_e_fail = makeTop(cid,_fOut,"topen_fail",targetmc,controlmc_e_fail,systs_e_fail,False)
  TopScales_sig_fail  = makeTop(cid,_fOut,"sigtop_fail",targetmc,controlmc_sig_fail,None,False)
  ...
  CRs = [
   ...
   Channel("signaltopfailModel",  _wspace,out_ws,cid+'_'+model,TopScales_sig_fail),
  ]
  ...
  addTopErrors(TopScales_sig_fail,targetmc,"sigtop_fail","signaltopfailModel",_fOut,CRs,6,cid,False)

...
samples_2hdm=(ZpA0-600-300 ZpA0-600-400 ZpA0-800-300 ZpA0-800-400 ZpA0-800-500 ZpA0-800-600 ZpA0-1000-300 ZpA0-1000-400 ZpA0-1000-500 ZpA0-1000-600 ZpA0-1000-700 ZpA0-1000-800 ZpA0-1400-300 ZpA0-1400-400 ZpA0-1400-500 ZpA0-1400-600 ZpA0-1400-700 ZpA0-1400-800 ZpA0-1700-300 ZpA0-1700-400 ZpA0-1700-500 ZpA0-1700-600 ZpA0-1700-700 ZpA0-1700-800 ZpA0-2000-300 ZpA0-2000-400 ZpA0-2000-400 ZpA0-2000-500 ZpA0-2000-600 ZpA0-2000-700 ZpA0-2000-800 ZpA0-2500-300 ZpA0-2500-400 ZpA0-2500-500 ZpA0-2500-600 ZpA0-2500-700 ZpA0-2500-800 ZpA0-2750-300 ZpA0-2750-500 ZpA0-2750-800 ZpA0-3000-300 ZpA0-3000-500 ZpA0-3000-800 ZpA0-3500-300 ZpA0-3500-500 ZpA0-3500-800 ZpA0-4000-300 ZpA0-4000-500 ZpA0-4000-800 )
#samples_2hdm=(ZpA0-1700)

echo "med dm twosigdown onesigdown exp onesigup twosigup" > limits_2hdm_postfit.txt
...
for k in "${samples_2hdm[@]}"; do
    ...
    #Computing limits
    combine -M Asymptotic combined.txt  --rAbsAcc 0 --rMax 10 --verbose 3 | tee limits_tmp.txt
    ...
    echo "${mediator} ${dmmass} ${twosigdown} ${onesigdown} ${exp} ${onesigup} ${twosigup} ${observed}" >> limits_2hdm_postfit.txt
done

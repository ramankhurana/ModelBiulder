...
echo "med dm twosigdown onesigdown exp onesigup twosigup observed" > limits_barzp_finebinning.txt
...
for k in "${samples_2hdm[@]}"; do
    ...
    echo "${mediator} ${dm} ${twosigdown} ${onesigdown} ${exp} ${onesigup} ${twosigup} ${observed}" >> limits_barzp_finebinning.txt

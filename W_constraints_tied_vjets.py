...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  wtopmn_fail_ratio_trig_up = targetmc.Clone(); wtopmn_fail_ratio_trig_up.SetName('wtopmn_fail_weights_%s_mettrig_Up'%cid)
  for b in range(wtopmn_fail_ratio_trig_up.GetNbinsX()): wtopmn_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wtopmn_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_wjets"))
  wtopmn_fail_ratio_trig_up.Divide(controlmc_ttbar_fail)
  _fOut.WriteTObject(wtopmn_fail_ratio_trig_up)

  wtopmn_fail_ratio_trig_down = targetmc.Clone(); wtopmn_fail_ratio_trig_down.SetName('wtopmn_fail_weights_%s_mettrig_Down'%cid)
  for b in range(wtopmn_fail_ratio_trig_down.GetNbinsX()): wtopmn_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wtopmn_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_wjets"))
  wtopmn_fail_ratio_trig_down.Divide(controlmc_ttbar_fail)
  _fOut.WriteTObject(wtopmn_fail_ratio_trig_down)

  wtopen_fail_ratio_trig_up = targetmc.Clone(); wtopen_fail_ratio_trig_up.SetName('wtopen_fail_weights_%s_mettrig_Up'%cid)
  for b in range(wtopen_fail_ratio_trig_up.GetNbinsX()): wtopen_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wtopen_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_wjets"))
  wtopen_fail_ratio_trig_up.Divide(controlmc_ttbar_e_fail)
  _fOut.WriteTObject(wtopen_fail_ratio_trig_up)

  wtopen_fail_ratio_trig_down = targetmc.Clone(); wtopen_fail_ratio_trig_down.SetName('wtopen_fail_weights_%s_mettrig_Down'%cid)
  for b in range(wtopen_fail_ratio_trig_down.GetNbinsX()): wtopen_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wtopen_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_wjets"))
  wtopen_fail_ratio_trig_down.Divide(controlmc_ttbar_e_fail)
  _fOut.WriteTObject(wtopen_fail_ratio_trig_down)
  ...
  wmn_fail_ratio_trig_up = targetmc.Clone(); wmn_fail_ratio_trig_up.SetName('wmn_fail_weights_%s_mettrig_Up'%cid)
  for b in range(wmn_fail_ratio_trig_up.GetNbinsX()): wmn_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wmn_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_wjets"))
  wmn_fail_ratio_trig_up.Divide(controlmc_fail)
  _fOut.WriteTObject(wmn_fail_ratio_trig_up)

  wmn_fail_ratio_trig_down = targetmc.Clone(); wmn_fail_ratio_trig_down.SetName('wmn_fail_weights_%s_mettrig_Down'%cid)
  for b in range(wmn_fail_ratio_trig_down.GetNbinsX()): wmn_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wmn_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_wjets"))
  wmn_fail_ratio_trig_down.Divide(controlmc_fail)
  _fOut.WriteTObject(wmn_fail_ratio_trig_down)

  wen_fail_ratio_trig_up = targetmc.Clone(); wen_fail_ratio_trig_up.SetName('wen_fail_weights_%s_mettrig_Up'%cid)
  for b in range(wen_fail_ratio_trig_up.GetNbinsX()): wen_fail_ratio_trig_up.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wen_fail_ratio_trig_up,h_trig_up,metname,metname,_wspace.data("signal_wjets"))
  wen_fail_ratio_trig_up.Divide(controlmc_e_fail)
  _fOut.WriteTObject(wen_fail_ratio_trig_up)

  wen_fail_ratio_trig_down = targetmc.Clone(); wen_fail_ratio_trig_down.SetName('wen_fail_weights_%s_mettrig_Down'%cid)
  for b in range(wen_fail_ratio_trig_down.GetNbinsX()): wen_fail_ratio_trig_down.SetBinContent(b+1,0)
  diag.generateWeightedTemplate(wen_fail_ratio_trig_down,h_trig_down,metname,metname,_wspace.data("signal_wjets"))
  wen_fail_ratio_trig_down.Divide(controlmc_e_fail)
  _fOut.WriteTObject(wen_fail_ratio_trig_down)
  ...
  for i in range(1,WScales_fail.GetNbinsX()+1):
    ...
    WScale_doubleb_failUp.SetBinContent(i,val_fail*(1+double_b_uncs[i-1]))
    WScale_doubleb_failDown.SetBinContent(i,val_fail*(1-double_b_uncs[i-1]))
    WScale_e_doubleb_failUp.SetBinContent(i,val_e_fail*(1+double_b_uncs[i-1]))
    WScale_e_doubleb_failDown.SetBinContent(i,val_e_fail*(1-double_b_uncs[i-1]))
    WScale_ttbar_doubleb_failUp.SetBinContent(i,val_ttbar_fail*(1+double_b_uncs[i-1]))
    WScale_ttbar_doubleb_failDown.SetBinContent(i,val_ttbar_fail*(1-double_b_uncs[i-1]))
    WScale_ttbar_e_doubleb_failUp.SetBinContent(i,val_ttbar_e_fail*(1+double_b_uncs[i-1]))
    WScale_ttbar_e_doubleb_failDown.SetBinContent(i,val_ttbar_e_fail*(1-double_b_uncs[i-1]))

  WScale_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("wmn_fail",cid,cid))
  WScale_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("wmn_fail",cid,cid))

  WScale_e_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("wen_fail",cid,cid))
  WScale_e_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("wen_fail",cid,cid))

  WScale_ttbar_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("wtopmn_fail",cid,cid))
  WScale_ttbar_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("wtopmn_fail",cid,cid))

  WScale_ttbar_e_doubleb_failUp.SetName('%s_weights_%s_%s_doubleb_vjets_Up'%("wtopen_fail",cid,cid))
  WScale_ttbar_e_doubleb_failDown.SetName('%s_weights_%s_%s_doubleb_vjets_Down'%("wtopen_fail",cid,cid))
  ...
  CRs[2].add_nuisance_shape('%s_doubleb_vjets'%(cid),_fOut)
  CRs[3].add_nuisance_shape('%s_doubleb_vjets'%(cid),_fOut)
  CRs[4].add_nuisance_shape('%s_doubleb_vjets'%(cid),_fOut)
  CRs[5].add_nuisance_shape('%s_doubleb_vjets'%(cid),_fOut)
  '''

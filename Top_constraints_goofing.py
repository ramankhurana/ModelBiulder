...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  addTopErrors(TopScales,    targetmc,"topmn", "singlemuontopModel",     _fOut,CRs,0,cid,False)
  addTopErrors(TopScales_e,  targetmc,"topen", "singleelectrontopModel", _fOut,CRs,1,cid,False)
  ...
  addTopErrors(TopScales_fail, targetmc,"topmn_fail", "singlemuontopfailModel",   _fOut,CRs,4,cid, False)
  addTopErrors(TopScales_e_fail, targetmc,"topen_fail", "singleelectrontopfailModel",   _fOut,CRs,5,cid, False)

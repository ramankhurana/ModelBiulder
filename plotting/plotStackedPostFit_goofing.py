...
#    legend.AddEntry(h_fcnc,'FCNC M_{V}=0.9 TeV','l')
  ...
  c.SaveAs(plotsDir+"MSDcorr_stackedPostfit_"+region+"_goofing.pdf")
  c.SaveAs(plotsDir+"MSDcorr_stackedPostfit_"+region+"_goofing.png")
  c.SaveAs(plotsDir+"MSDcorr_stackedPostfit_"+region+"_goofing.C")

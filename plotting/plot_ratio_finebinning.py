...
def plot_ratio(process):
    ...
    if (process=='wz'):
        dirname = 'Z_constraints_finebinning_category_monohiggs'
    ...
    if (process=='singleelectronw'):
        dirname = "W_constraints_finebinning_category_monohiggs" 
    ...
    if (process=='singleelectrontop'):
        dirname = "Top_constraints_finebinning_category_monohiggs" 

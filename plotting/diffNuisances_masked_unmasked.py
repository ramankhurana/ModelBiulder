...
if options.plotfile:
    ...
    leg.AddEntry(gr_fit_b,"B-only unmasked","EPL")
    leg.AddEntry(gr_fit_s,"B-only masked"   ,"PL")
    leg.Draw()
    ...
    canvas_nuis.SaveAs(plotsDir+"pulls_masked_unmasked.pdf") 
    canvas_nuis.SaveAs(plotsDir+"pulls_masked_unmasked.png") 
    canvas_nuis.SaveAs(plotsDir+"pulls_masked_unmasked.C") 

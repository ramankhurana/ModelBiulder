...
#    legend.AddEntry(h_fcnc,'FCNC M_{V}=0.9 TeV','l')
  ...
  latex2.DrawLatex(0.92, 0.963,"%.1f fb^{-1} (13 TeV)"%(plotConfig_mT.lumi))
  ...
  plotsDir = plotConfig_mT.plotDir


  c.SaveAs(plotsDir+"monoHbb_"+region+".pdf")
  c.SaveAs(plotsDir+"monoHbb_"+region+".png")
  c.SaveAs(plotsDir+"monoHbb_"+region+".C")

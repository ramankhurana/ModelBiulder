...
#    legend.AddEntry(h_fcnc,'FCNC M_{V}=0.9 TeV','l')
  ...
  c.SaveAs("~/public_html/figs/monohiggs/merged/v12/limits_private/MSDcorr_stackedPostfit_"+region+".pdf")
  c.SaveAs("~/public_html/figs/monohiggs/merged/v12/limits_private/MSDcorr_stackedPostfit_"+region+".png")
  c.SaveAs("~/public_html/figs/monohiggs/merged/v12/limits_private/MSDcorr_stackedPostfit_"+region+".C")
